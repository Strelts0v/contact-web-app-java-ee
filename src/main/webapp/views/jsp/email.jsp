            ...
            <div class="panel panel-default text-left">
                <div class="panel-body">
                    ...
                    <div class="controls">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="form_email-to">To email *</label>
                                <div class="input-group">
                                    <input id="form_email-to" type="email" name="email-to" class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required.">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="form_message" name="message" class="form-control" placeholder="Message body *" rows="4"
